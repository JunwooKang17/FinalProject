...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into BOARD (title, writer, content, password) values (?,?,?,?)";
	private final String BOARD_UPDATE = "update BOARD set title=?, writer=?, content=?, password =? where seq=?";
